    ...
    <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            {entries.length === 0 
              ...
              : `You have ${entries.length} ${entries.length === 1 ? 'post' : 'posts'} — keep it up! 💪`
            }
          </p>
        </div>
      ...
      {entries.length === 0 ? (
        <div className="text-center py-20 px-4 bounce-in">
          ...
          <h2 className="text-3xl font-black gradient-text mb-2">No posts yet!</h2>
          <p className="text-muted-foreground text-lg mb-8 max-w-md mx-auto">
            Your journey starts here. Create your first forum post and watch the magic happen! ✨
          </p>
          <Link 
            href="/dashboard/new"
